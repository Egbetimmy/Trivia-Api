...
This project is a trivia app for Udacity students. Students are able to add questions and require that they include question and answer text, 
Search for questions based on a text query string, Delete questions, Display questions - both all questions and by category. 
Questions should show the question, category and difficulty rating by default and can show/hide the answer.
As a part of the Fullstack Nanodegree, it serves as a project module Course 2: API Development and Documentation. 
...
@sabinevidal, Manal Alshehri, Mohamed Zaitoon
